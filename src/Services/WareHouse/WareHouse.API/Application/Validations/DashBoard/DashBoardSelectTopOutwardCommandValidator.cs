...
{
    public class DashBoardSelectTopOutwardCommandValidator : AbstractValidator<DashBoardSelectTopOutwardCommand>
    {
        public DashBoardSelectTopOutwardCommandValidator()
        {
