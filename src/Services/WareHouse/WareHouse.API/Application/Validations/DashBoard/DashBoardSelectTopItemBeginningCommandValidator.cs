...
{
    public class DashBoardSelectTopItemBeginningCommandValidator : AbstractValidator<DashBoardSelectTopItemBeginningCommand>
    {
        public DashBoardSelectTopItemBeginningCommandValidator()
        {
