...
@Component({
  selector: 'app-ListAppCreate',
  templateUrl: './ListAppCreate.component.html',
  styleUrls: ['./ListAppCreate.component.scss']
})
export class ListAppCreateComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ListAppCreateComponent>,
