...
@Component({
  selector: 'app-ListAuthozireEdit',
  templateUrl: './ListAuthozireEdit.component.html',
  styleUrls: ['./ListAuthozireEdit.component.scss']
})
export class ListAuthozireEditComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ListAuthozireEditComponent>,
